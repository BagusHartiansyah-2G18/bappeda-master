<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    function _tmSetting($p){
        ...
        //     "subMenu"=>[
        //         [
        //             "url"=>$router."control/prioritas",
        //             "menu"=>"Prioritas",
        //             "ha"=>$user,
        //             "status"=>""
        //         ],[
        //             "url"=>$router."control/subPrioritas/null",
        //             "menu"=>"Sub Prioritas",
        //             "ha"=>$user,
        //             "status"=>""
        //         ],[
        ...
        array_push($menuSupport,[
            "nm"=>"Prioritas",
            "ic"=>'<i class="mdi mdi-chart-bar-stacked menu-icon"></i>',
            "cls"=>'text-dark',
            "url"=>$router."control/prioritas",
            "ac"=>"",
            "ha"=>$super,
        ...
        array_push($menuSupport,[
            "nm"=>"Sub Prioritas",
            "ic"=>'<i class="mdi mdi-greenhouse menu-icon"></i>',
            "cls"=>'text-dark',
            "url"=>$router."control/subPrioritas/null",
            "ac"=>"",
            "ha"=>$super,
